import Observable from '@aws-amplify/datastore/lib-esm/datastore/node_modules/zen-observable-ts';
import { PredicateAll } from '@aws-amplify/datastore/lib-esm/predicates';
import { ConflictHandler, DataStoreConfig, ModelInit, ModelInstanceMetadata, NonModelTypeConstructor, ProducerPaginationInput, PersistentModel, PersistentModelConstructor, ProducerModelPredicate, Schema, SubscriptionMessage, ErrorHandler } from '@aws-amplify/datastore/lib-esm/types';
